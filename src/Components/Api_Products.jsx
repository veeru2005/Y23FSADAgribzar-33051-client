...
const MockDataProducts = () => {
  ...
  return (
    <div style={{ backgroundColor: '#fff', padding: '20px' }}>
      <h1 style={{ textAlign: 'center' }}>Mock Data Products</h1>
      <div
        style={{
          display: 'grid',
          ...
          alignItems: 'stretch',  // Align all items to stretch to the same height
        ...
        {products.map(product => (
          <div
            ...
            style={{
              ...
              height: '100%', // Ensure all boxes are stretched to the same height
            }}
          >
            <img
              src={product.image}
            ...
            />
            <div style={{ flexGrow: 1 }}> {/* Allow description and title to fill the space */}
              <h3 style={{ fontSize: '1rem', margin: '10px 0' }}>{product.title}</h3>
              <p style={{ fontSize: '0.9rem', marginBottom: '10px' }}>{product.description}</p>
            </div>
            <p style={{ fontWeight: 'bold', marginTop: 'auto' }}>Price: ${product.price}</p>
          </div>
        ))}
      </div>
    </div>
